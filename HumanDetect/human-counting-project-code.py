...
def detect(frame):
    ...
    bounding_box_cordinates, weights =  HOGCV.detectMultiScale(frame, winStride = (12, 12), padding = (8, 8), scale = 1.05)
...
if __name__ == "__main__":
    ...
    args = argsParser()
    #humanDetector(args)
    humanDetector({'video': None, 'image': None, 'camera': 'true', 'output': None})
    print(args)
